...
public class ExampleComplexRestriction {
	...
	public static void main(String[] args) {
		...
		// defined later)
		builder.setNamespace("tosca", "https://intelligence.csd.auth.gr/ontologies/tosca/").subject(r1)
				.add(RDF.TYPE, OWL.RESTRICTION).add(OWL.ONPROPERTY, "tosca:Requirements").add(OWL.SOMEVALUESFROM, r2);

		// definition of r3 and its association with r4
		builder.setNamespace("tosca", "https://intelligence.csd.auth.gr/ontologies/tosca/").subject(r3)
				.add(RDF.TYPE, OWL.RESTRICTION).add(OWL.ONPROPERTY, "tosca:host").add(OWL.SOMEVALUESFROM, r4);

		// definition of r4
		builder.setNamespace("tosca", "https://intelligence.csd.auth.gr/ontologies/tosca/").subject(r4)
				.add(RDF.TYPE, OWL.RESTRICTION).add(OWL.ONPROPERTY, "tosca:capability")
				.add(OWL.SOMEVALUESFROM, "tosca:tosca.capabilities.Compute");

		// definition of r5
		builder.setNamespace("tosca", "https://intelligence.csd.auth.gr/ontologies/tosca/").subject(r5)
				.add(RDF.TYPE, OWL.RESTRICTION).add(OWL.ONPROPERTY, "tosca:node")
				.add(OWL.SOMEVALUESFROM, "tosca:tosca.nodes.Compute");

		// definition of r6
		builder.setNamespace("tosca", "https://intelligence.csd.auth.gr/ontologies/tosca/").subject(r6)
				.add(RDF.TYPE, OWL.RESTRICTION).add(OWL.ONPROPERTY, "tosca:relationship")
